...
def playlist(id):
    ...
    return render_template("playlist.html", playlist_name=playlist_name, refresh_button=refresh_button, pick_playlist_button=pick_playlist_button, home_button=home_button)